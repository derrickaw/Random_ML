 ...
 * @version 1.0
 */
public class MaxKColoringTestUpdated {
    /** The n value */
    private static int N = 50; // number of vertices
    private static int L = 4; // L adjacent nodes per vertex
    private static int K = 8; // K possible colors
